...
const AboutMe = () => (
  <div className="container mx-auto px-5 mb-8">
    <div className="flex flex-col md:flex-row items-center"> {/* Adjust layout for responsiveness */}
      <Image
        unoptimized
        ...
        height="450px"
        width="450px"
        className="rounded-full shadow-lg" // Add rounded borders and shadow to the image
        src="/Blog-img.jpeg"
      />
